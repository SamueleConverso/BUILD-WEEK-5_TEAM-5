...
const FormAnimaleSmarrito = ({ onSubmit, isLoading }) => {
  ...
  const handleSubmit = (e) => {
    ...
    const formData = {
      ...
      colore,
      microchip,
      numeroMicrochip: microchip && numeroMicrochip ? parseInt(numeroMicrochip) : null
    };
    ...
    <div className="card mb-4">
      ...
      <div className="card-body">
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-3">
            <label htmlFor="colore" className="form-label">Colore</label>
            <input
              type="text"
              className="form-control"
              id="colore"
          ...
          <div className="mb-3 form-check">
            ...
            />
            <label className="form-check-label" htmlFor="microchip">Microchip</label>
          </div>
          
          {microchip && (
            <div className="mb-3">
              <label htmlFor="numeroMicrochip" className="form-label">Numero Microchip</label>
              <input
                type="number"
                className="form-control"
                id="numeroMicrochip"
